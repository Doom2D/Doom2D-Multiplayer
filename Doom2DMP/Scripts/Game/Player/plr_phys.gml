...
if !global.cl_physics {exit;}

//controls
if argument0 && !argument1
{
    if hsp > -maxhspd {hsp -= acc;}
    //if !kb_strf {image_xscale = -1;}
}
...
if argument2 && !free
{
    if collision_rectangle(x-16, y, x+16, y+16, o_liq, 0, 1) && !place_meeting(x, y + 1, o_solid) && !place_meeting(x, y + 1, o_jthr)
    {
        vsp = -2.75;
    }
    else
