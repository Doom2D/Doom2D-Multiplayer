...
str[2, 0] = 'Записи';
str[2, 1] = 'global.dem_fn = string_replace(get_open_filename("Записи геймплея Doom2DMP 0.6 (*.DGP)|*.dgp", "demos\*.dgp"), working_directory + "\", ""); if global.dem_fn == "" {exit;}; global.dem_menu = 0; global.menu_id = 0; global.dem_will = "PLAY"; room_goto(rm_game);';
str[3, 0] = 'Настройки';
