...
str[2, 0] = 'Записи';
str[2, 1] = 'var dem_fn; dem_fn = path_relative(get_open_filename("Записи геймплея Doom2DMP 0.6 (*.DGP)|*.dgp", "demos\*.dgp")); if !file_exists(dem_fn) {exit;} global.dem_fn = dem_fn; global.dem_menu = 0; global.menu_id = 0; room_goto(rm_game);';
str[3, 0] = 'Настройки';
