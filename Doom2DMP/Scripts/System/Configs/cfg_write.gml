...
file_text_writeln(cfg);
file_text_write_string(cfg, 'bind ' + key_name(global.key_use) + ' +use');
file_text_writeln(cfg);
...
file_text_writeln(cfg);
file_text_write_string(cfg, 'r_depth ' + string(global.r_depth));
file_text_writeln(cfg);
file_text_write_string(cfg, 'r_drawhud ' + string(global.r_drawhud));
file_text_writeln(cfg);
file_text_write_string(cfg, 'r_wsplash ' + string(global.r_wsplash));
file_text_writeln(cfg);
...
file_text_writeln(cfg);
file_text_write_string(cfg, 'cl_interp ' + string(global.cl_interp));
file_text_writeln(cfg);
file_text_write_string(cfg, 'cl_physics ' + string(global.cl_physics));
file_text_writeln(cfg);
