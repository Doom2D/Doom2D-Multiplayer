...
file_text_writeln(cfg);
file_text_write_string(cfg, 'sv_mastersrv ' + string(global.sv_mastersrv));
file_text_writeln(cfg);
file_text_write_string(cfg, 'sv_slist_upd ' + string(global.sv_slist_upd));
file_text_writeln(cfg);
...
file_text_writeln(cfg);
file_text_write_string(cfg, 'sv_voting ' + string(global.sv_voting));
file_text_writeln(cfg);
file_text_write_string(cfg, 'sv_voting_time ' + string(global.sv_voting_time));
file_text_writeln(cfg);
...
file_text_writeln(cfg);
file_text_write_string(cfg, 'sv_autosave ' + string(global.sv_autosave));
file_text_writeln(cfg);
file_text_write_string(cfg, 'sv_log_update ' + string(global.sv_log_update));
file_text_writeln(cfg);
file_text_write_string(cfg, 'sv_autoexec ' + string(global.sv_autoexec));
file_text_writeln(cfg);
file_text_write_string(cfg, 'sv_priority ' + string(global.sv_priority));
file_text_writeln(cfg);
...
file_text_writeln(cfg);
file_text_write_string(cfg, 'mp_caplimit ' + string(global.mp_caplimit));
file_text_writeln(cfg);
...
file_text_writeln(cfg);
file_text_write_string(cfg, 'mp_waterbfgdmg ' + string(global.mp_waterbfgdmg));
file_text_writeln(cfg);
...
file_text_writeln(cfg);
file_text_write_string(cfg, 'bot_userate ' + string(global.bot_userate));
file_text_writeln(cfg);
