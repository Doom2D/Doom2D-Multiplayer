...
if is_real(argument1) || string_letters(argument1) != '' || argument0 == 'sv_ip' || (argument0 == 'sv_port' && global.map_w > 0) || (argument0 == 'sv_maxplayers'&& global.map_w > 0) || (argument0 == 'mp_fraglimit'&& global.map_w > 0) || (argument0 == 'mp_scorelimit'&& global.map_w > 0) || (argument0 == 'mp_gamemode'&& global.map_w > 0) {con_add(string(variable_global_get(argument0))); exit;}
