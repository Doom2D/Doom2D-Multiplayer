//updates entry to the serverlist
//a0 - server name
//a1 - server map
if global.sv_lan {exit;}
var _sl_sock, _sl_str, _sl_name, _sl_map, _sl_host;

_sl_name = net_url_encode(argument0);
_sl_map = net_url_encode(argument1);
...
else
{
    ...
    dll39_write_chars("GET " + global.sv_slist_path + "insert.php?name=" + _sl_name + "&player=" + _sl_map + " HTTP/1.1" + _sl_str,0);
    ...
    con_add(':: NET: SLIST: Синхронизация с серверлистом успешна.');
}
