...
if global.sv_cycle_maps == 1
{
    ...
    if global.map_list_ind == -1  
    {
        global.map_list_next = string(list_get_val('map_list', irandom(list_get_len('map_list') - 1)));
        if global.map_list_next == '0' {global.map_list_next = global.sv_map;}
        exit;
    } 
    else
    {
...
if global.sv_cycle_maps == 2
{
    ...
    if ds_list_find_index(global.map_played, global.sv_map) == -1 {ds_list_add(global.map_played, global.sv_map);}
