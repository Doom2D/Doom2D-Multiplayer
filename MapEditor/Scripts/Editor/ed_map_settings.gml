...
ui_win3_e3 = API_Edit_Create(ui_win3, 4, 97, 160, 20, WS_DLGFRAME);
API_Control_SetText(ui_win3_e3, global.map_name);
ui_win3_e4 = API_Edit_Create(ui_win3, 4, 117, 160, 20, WS_DLGFRAME);
API_Control_SetText(ui_win3_e4, global.map_desc);
ui_win3_b3 = API_Button_Create(ui_win3, 48, 147, 68, 24, BS_PUSHBUTTON);
API_Control_SetText(ui_win3_b3, "Применить");
