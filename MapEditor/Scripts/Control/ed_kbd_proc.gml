...
if keyboard_check_pressed(ord('1')) {with o_solid   {if visible == 1 {visible = 0;} else {visible = 1;}}}
if keyboard_check_pressed(ord('2')) {with o_jthr    {if visible == 1 {visible = 0;} else {visible = 1;}}}
if keyboard_check_pressed(ord('3')) {with o_bkg     {if visible == 1 {visible = 0;} else {visible = 1;}}}
if keyboard_check_pressed(ord('4')) {with o_frg     {if visible == 1 {visible = 0;} else {visible = 1;}}}
if keyboard_check_pressed(ord('5')) {with o_liquid  {if visible == 1 {visible = 0;} else {visible = 1;}}}
if keyboard_check_pressed(ord('6')) {with o_lift    {if visible == 1 {visible = 0;} else {visible = 1;}}}
if keyboard_check_pressed(ord('7')) {with o_item    {if visible == 1 {visible = 0;} else {visible = 1;}}}
if keyboard_check_pressed(ord('8')) {with o_spawn   {if visible == 1 {visible = 0;} else {visible = 1;}}}
if keyboard_check_pressed(ord('9')) {with o_trigger {if visible == 1 {visible = 0;} else {visible = 1;}}}
if keyboard_check_pressed(ord('0')) {with par_obj   {visible = 1}}
...
if keyboard_check_pressed(vk_f9)
{
  ...
  screen_save('screenshots\ed_' + 
              string(current_day) + '-' + string(current_month) + '-' + string(current_year) + '_' +
