...
ui_win3_t4 = API_Static_Create(ui_win3, 4, 80, 96, 16, 0, 0);
API_Control_SetText(ui_win3_t4, "Высота:" );
ui_win3_e2 = API_Edit_Create(ui_win3, 100, 77, 64, 20, ES_NUMBER, WS_EX_CLIENTEDGE);
API_Control_SetText(ui_win3_e2, string(global.map_h));

ui_win3_e3 = API_Edit_Create(ui_win3, 4, 100, 160, 20, ES_AUTOHSCROLL, WS_EX_CLIENTEDGE);
API_Control_SetText(ui_win3_e3, global.map_name);

ui_win3_e4 = API_Edit_Create(ui_win3, 4, 122, 160, 20, ES_AUTOHSCROLL, WS_EX_CLIENTEDGE);
